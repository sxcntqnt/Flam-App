...
import 'package:ridesharing/feature/dashboard/incidents/incidents_widget.dart';
...
import 'package:ridesharing/feature/dashboard/requests/requests_widget.dart';
import 'package:ridesharing/feature/dashboard/tipjar/tipjar_widget.dart';
          ...
          items: <BottomNavigationBarItem>[
            ...
            BottomNavigationBarItem(
              icon: SvgPicture.asset(
                _selectedIndex == 5
                    ? Assets
                          .heartFillIcon // Using heart icon as placeholder for incidents
                    : Assets.heartIcon,
            ...
            BottomNavigationBarItem(
              icon: SvgPicture.asset(
                _selectedIndex == 6
                    ? Assets
                          .heartFillIcon // Using heart icon as placeholder for requests
                    : Assets.heartIcon,
            ...
            BottomNavigationBarItem(
              icon: SvgPicture.asset(
                _selectedIndex == 7
                    ? Assets
                          .heartFillIcon // Using heart icon as placeholder for tipjar
                    : Assets.heartIcon,
